...
<head>
    ...
    <script src="js/jquery.manual-trigger.js"></script>
    ...
    <script type="text/javascript" src="http://alimd.github.io/libs/html5shiv/3.6.2/html5shiv.min.js"></script>
...
<!-- This is the logo and navigation -->
  ...
  <div class="body-container">
    ...
    <script type="text/javascript">
        ...
        var disqus_shortname = '1tajrobe'; // required: replace example with your forum shortname
